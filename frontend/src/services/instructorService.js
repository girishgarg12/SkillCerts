...
export const instructorService = {
  ...
  reorderSections: (courseId, sectionIds) =>
    api.patch(`/sections/course/${courseId}/reorder`, { sectionIds }),
  ...
  reorderLectures: (sectionId, lectureIds) =>
    api.patch(`/lectures/section/${sectionId}/reorder`, { lectureIds }),
};
