...
export const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 relative overflow-hidden py-20">
      {/* Background Effects */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl opacity-30" />
        <div className="absolute bottom-1/3 left-1/4 w-96 h-96 bg-slate-600/10 rounded-full blur-3xl opacity-30" />
      </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`px-2 py-2.5 rounded-xl font-medium transition-all text-xs border ${formData.role === 'student'
                  ...
                  <button
                    ...
                    className={`px-2 py-2.5 rounded-xl font-medium transition-all text-xs border ${formData.role === 'instructor'
                        ? 'bg-blue-600 text-white border-blue-500 shadow-lg shadow-blue-500/25'
                        : 'bg-white/5 text-gray-400 border-white/10 hover:bg-white/10 hover:text-white'
                      }`}
                  >
                ...
                <div className="flex flex-wrap gap-2 max-h-40 overflow-y-auto pr-2 custom-scrollbar">
                  {INTERESTS.map(interest => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all border ${formData.interests.includes(interest)
