  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-2 sm:p-4 overflow-auto" onClick={onClose}>
      <div className="relative w-full max-w-6xl my-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div
          ref={certificateRef}
          className="certificate-container bg-gradient-to-br from-blue-600 via-blue-700 to-slate-800 p-3 sm:p-6 rounded-lg"
        >
          <div className="bg-white rounded-lg shadow-2xl p-6 sm:p-10 lg:p-16 relative aspect-[1.414/1]">
            ...
            {/* Inner border */}
            <div className="absolute top-6 left-6 right-6 bottom-6 sm:top-8 sm:left-8 sm:right-8 sm:bottom-8 border-2 border-blue-200 rounded-md pointer-events-none" />
            ...
            <div className="relative z-10 text-center h-full flex flex-col justify-between">
              ...
              <div className="mb-2 sm:mb-4">
                <div className="flex items-center justify-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                  ...
                  <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent tracking-wider uppercase">
                    SkillCert
                  </h1>
                  <Award className="w-6 h-6 sm:w-10 sm:h-10 text-blue-600" />
                </div>
