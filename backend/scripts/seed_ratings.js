...
const dummyReviews = [
  {
    rating: 5,
    comment:
      'Absolutely amazing course! The instructor explains everything so clearly.',
  },
  {
    rating: 4,
    comment:
      'Great content, but could use more practical examples in the advanced sections.',
  },
  { rating: 5, comment: 'Best investment for my career. Highly recommended!' },
  {
    rating: 3,
    comment: 'Good basics, but I expected more depth on some topics.',
  },
  {
    rating: 5,
    comment:
      'The project-based approach really helped me understand the concepts better.',
  },
  {
    rating: 4,
    comment:
      'Solid course structure. The audio quality could be improved slightly.',
  },
  {
    rating: 5,
    comment:
      'Exceeded my expectations. I feel confident applying these skills now.',
  },
  {
    rating: 4,
    comment:
      'Very comprehensive. A bit fast-paced at times, but great overall.',
  },
];
...
const seedRatings = async () => {
  try {
    ...
    for (const course of courses) {
      ...
      console.log(
        `Updated ${course.title}: ${course.rating.toFixed(1)} stars (${course.ratingCount} reviews)`
      );
    }
