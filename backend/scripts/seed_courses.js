...
const sampleCourses = [
  // ... (same sampleCourses array) ...
  {
    ...
    description:
      'Learn full-stack web development from scratch. HTML, CSS, Javascript, React, Node.js and more.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Master advanced React concepts, hooks, and performance optimization techniques.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Introduction to Python programming and data analysis libraries like Pandas and NumPy.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Hands-on machine learning course using Python. Build predictive models and neural networks.',
    thumbnail:
      'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=2665&auto=format&fit=crop',
    price: 129.99,
    isFree: false,
    level: 'intermediate',
    language: 'English',
  ...
  },
  {
    ...
    description:
      'Design beautiful user interfaces and user experiences using Figma and Adobe XD.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      'Build native iOS and Android apps using a single codebase with Flutter and Dart. This comprehensive course takes you from zero to hero in mobile app development.',
  ...
  },
  {
    ...
    description:
      'Master Docker, Kubernetes, Jenkins, and AWS to become a certified DevOps engineer. Learn the industry-standard CI/CD pipelines and infrastructure as code.',
  ...
  },
  {
    ...
    description:
      'Learn the basics of ethical hacking, network security, and cryptography. Prepare for standard industry certifications and secure your digital assets.',
    thumbnail: '/cyber.png',
    price: 89.99,
    isFree: false,
    level: 'beginner',
  ...
  },
  {
    ...
    description:
      'Understand how blockchain works internally and build your own cryptocurrency. Deep dive into smart contracts and decentralized applications.',
    thumbnail:
      'https://plus.unsplash.com/premium_photo-1681400678259-255b10890b08?q=80&w=2679&auto=format&fit=crop',
    price: 119.99,
    isFree: false,
    level: 'intermediate',
    language: 'English',
...
const seedCourses = async () => {
  try {
    const mongoUri =
      env.MONGODB_URI || 'mongodb://localhost:27017/course-platform';
    ...
    for (const courseData of sampleCourses) {
      ...
      const slug = courseData.categoryName
        .toLowerCase()
        .replace(/[^\w\s-]/g, '')
        .replace(/\s+/g, '-');
